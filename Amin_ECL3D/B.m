...
% Last Modified by GUIDE v2.5 05-Aug-2014 16:41:29
...
% varargin   command line arguments to B (see VARARGIN)

% Choose default command line output for B
...
% --- Executes on button press in Send_B.
function Send_B_Callback(hObject, eventdata, handles)
G=str2double(get(handles.edit1,'String'));
setappdata(0,'fucker',G);
TestforCallback;
